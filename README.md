...
[release]: https://github.com/dreadl0ck/go-dnsmasq/releases
...
Download the binary for your OS from the [releases page](https://github.com/dreadl0ck/go-dnsmasq/releases/latest).    
